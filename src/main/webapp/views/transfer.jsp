...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    ...
    <body>
        ...
        <form action="/transferUrl">
          <header><h1>TRANSFER FORM</h1></header>  
            <div class="container">
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter your first name" name="name">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                      <label for="acno"> Target Account Number</label>
                      <input type="text" class="form-control" placeholder="Enter your account number" name="accno">
                    </div>
             ...
             <footer><input type="submit" value="Transfer" class="btn">&nbsp;&nbsp;&nbsp;
